var elBtn = document.querySelector(".button-52");
...
function getSaying() {
    let randomNumber = Math.floor(Math.random() * (saying.length));
    document.getElementById('saying-desc').innerHTML = saying[randomNumber];
}

elBtn.addEventListener("click", getSaying);
